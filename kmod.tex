...
\paragraph{kmod\_ctx 模块}

\paragraph{kmod\_module 模块}

\subsubsection{中间层}

\paragraph{kmod\_config 模块}

\paragraph{hash 模块}

\paragraph{kmod\_elf 模块}

\paragraph{kmod\_file 模块}

\subsubsection{抽象层}

\paragraph{init\_module 系统调用模拟}
...
\subsubsection{kmod\_new() 接口}

\subsubsection{kmod\_unref() 接口}

\subsubsection{kmod\_module\_new\_from\_path() 接口}

\subsubsection{kmod\_module\_insert\_module() 接口}

\subsubsection{kmod\_module\_unref() 接口}
...
\end{verbatim}\end{shaded}}
\paragraph{kmod\_module\_remove\_module 代码分析}
