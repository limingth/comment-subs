 ...
 * @note 注释详细内容:                                                
 *
 * @brief  初始化当前链表，当前节点的prev, next都指向自己
 */
 ...
 * @note 注释详细内容:                                                
 *
 * @brief  将当前链表增添一个节点元素，如原链表为空，则用当前节点元素创建链表
 */
 ...
 * @note 注释详细内容:                                                
 * 
 * @brief  在链表当前节点 list 后插入一个节点元素 node
 * 如原链表为空，则用插入节点元素创建链表。
 ...
 * @note 注释详细内容:                                                
 * 
 * @brief  在链表当前节点 list 前插入一个节点元素 node
 * 如原链表为空，则用插入节点元素创建链表。
 * 如原链表不为空，插入节点元素后调整链表相关指针
 */
 ...
 * @note 注释详细内容:                                                
 * 
 * @brief  将链表 list1 后加上append 链表 list2
 ...
 * @note 注释详细内容:                                                
 *
 * @brief  在当前 kmod list 的后面，新增一个节点 node，数据为 data
 */
 ...
 * @note 注释详细内容:                                                
 * 
 * @brief  在 kmod 链表当前节点 list 后插入一个节点元素 node
 * 如原链表为空，则用插入节点元素创建链表。
 * 如原链表不为空，插入节点元素后调整链表相关指针
 */
 ...
 * @note 注释详细内容:                                                
 * 
 * @brief  在 kmod 链表当前节点 list 前插入一个节点元素 node
 * 如原链表为空，则用插入节点元素创建链表。
 * 如原链表不为空，插入节点元素后调整链表相关指针
 */
 ...
 * @note 注释详细内容:                                                
 * 
 * @brief  将 kmod 链表 list1 后加上append 链表 list2
 * 如原链表 list1 为空，则用 list2 作为最后的链表
 */
 ...
 * @note 注释详细内容:                                                
 *
 * @brief  将当前 kmod 链表增添一个节点元素，如原链表为空，则用当前节点元素创建链表
 */
 ...
 * @note 注释详细内容:                                                
 * 
 * @brief  将当前 kmod 链表删除一个节点元素, 该元素的数据为传入参数 data 
 * 如原链表只有1个节点，则删除后置为空。
 * 如原链表不为空，删除节点元素后调整链表相关指针
 */
 ...
 * @note 注释详细内容:                                                
 *
 * @brief  返回在当前 kmod 链表 list 中，curr 节点的上一个节点 
 ...
 * @note 注释详细内容:                                                
 *
 * @brief  返回在当前 kmod 链表 list 中，curr 节点的下一个节点
 */
 ...
 * @note 注释详细内容:                                                
 *
 * @brief  如果链表为空，则返回空，否则返回链表中的最后那个节点
 */
